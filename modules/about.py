...
class AboutDialog(QDialog):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("About Rhya")
        layout = QVBoxLayout(self)

        # Load and scale the logo
        logo = QLabel(self)
        pixmap = QPixmap('Icons/Rhya.png')  # Ensure 'Icons/logo.png' is the correct path
        ...
        title_label = QLabel("Rhya - Toolkit for Retrieval and Analysis of Cyber Evidence")
        ...
        author_label = QLabel("Authors: Sandhya, Priyadharshini, Rithika, Saadhika")
